...
public class NoteReminderReceiver extends BroadcastReceiver {
    public static final String EXTRA_NOTE_TITLE    =  "com.example.selma.notekeeper.extra.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT    =  "com.example.selma.notekeeper.extra.NOTE_TEXT";
    public static final String EXTRA_NOTE_ID    =  "com.example.selma.notekeeper.extra.NOTE_ID";
